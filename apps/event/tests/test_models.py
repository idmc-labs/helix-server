...
class TestGenericValidator(HelixTestCase):
    ...
    def test_regional_coordinators(self):
        # Create ME and RC in monitoring sub reigon
        ...
        # Create ME and RC in another monitoring sub reigon
        ...
        # Test should return multiple reginal coordinators if actor is from different monitoring region
