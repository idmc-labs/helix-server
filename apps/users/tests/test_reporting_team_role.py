...
class TestReportingTeamRole(HelixGraphQLTestCase):
    def setUp(self) -> None:
        ...
        self.report = ReportFactory.create(name="GRID Report Test", is_public=True, created_by=self.admin)
    ...
    def test_reporting_team_user_can_create_update_delete_report(self):
        ...
        response = self.query(self.report_delete_mutation, variables={"id": report_id})
