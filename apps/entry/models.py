...
class Figure(MetaInformationArchiveAbstractModel,
    ...
    def get_figure_excel_sheets_data(cls, figures):
        headers = OrderedDict(
            ...
            entry__event__disaster_category='Disaster Category',
            entry__event__disaster_sub_category='Disaster Sub Category',
            entry__event__disaster_type='Disaster Type',
            entry__event__disaster_sub_type='Disaster Sub Type',
