...
class ExternalApiDump(models.Model):
    ...
    class ExternalApiType(models.TextChoices):
        ...
        GIDD_COUNTRY_REST = 'gidd-country-rest', _('GIDD country REST')
        GIDD_CONFLICT_REST = 'gidd-conflict-rest', _('GIDD conflict REST')
        GIDD_DISASTER_REST = 'gidd-disaster-rest', _('GIDD disaster REST')
        GIDD_DISPLACEMENT_REST = 'gidd-displacement-rest', _('GIDD displacement REST')
        ...
        GIDD_PUBLIC_FIGURE_ANALYSIS_REST = 'gidd-public-figure-analysis-rest', _('Public figure analysis REST')

        GIDD_CONFLICT_GRAPHQL = 'gidd-conflict-graphql', _('GIDD conflict Graphql')
        GIDD_DISASTER_GRAPHQL = 'gidd-disaster-graphql', _('GIDD disaster Graphql')
        GIDD_DISPLACEMENT_DATA_GRAPHQL = 'gidd-displacement-data-graphql', _('GIDD displacement data Graphql')
        GIDD_PFA_GRAPHQL = 'gidd-public-figure-analysis-graphql', _('GIDD public figure analysis Graphql')
        GIDD_CONFLICT_STAT_GRAPHQL = 'gidd-conflict-stat-graphql', _('GIDD conflict stat Graphql')
        GIDD_DISASTER_STAT_GRAPHQL = 'gidd-disaster-stat-graphql', _('GIDD disaster stat Graphql')
        GIDD_HAZARD_TYPES_GRAPHQL = 'gidd-hazard-type-graphql', _('GIDD hazard type Graphql')
        GIDD_YEAR_GRAPHQL = 'gidd-year-graphql', _('GIDD year Graphql')
        GIDD_EVENT_GRAPHQL = 'gidd-event-graphql', _('GIDD event Graphql')
        GIDD_COMBINED_STAT_GRAPHQL = 'gidd-combined-stat-graphql', _('GIDD combined stat Graphql')
        GIDD_RELEASE_META_DATA_GRAPHQL = 'gidd-release-meta-data-graphql', _('GIDD release meta data Graphql')
