readme_data_raw = [
    ...
    ("Location name", "Name of location were displacement was reported"),
    ("Latitude", "Latitude of the location reported"),
    ("Longitude", "Longitude of the location reported"),
    ("Location accuracy", "Accuracy of location"),
    ("Location type", "Type of location reported, Origin or Destination"),
    ("Entry ID", "Entry ID"),
