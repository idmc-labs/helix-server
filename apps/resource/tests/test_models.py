...
from utils.factories import ResourceFactory, ResourceGroupFactory
...
class TestResourceGroupModel(HelixTestCase):
    ...
    def test_resources_creation_by_user(self):
        ...
        with self.assertRaises(ValidationError):
            ...
            ResourceFactory.create_batch(RESOURCE_CREATED, created_by=self.reviewer, group=self.group)
    ...
    def test_resource_update(self):
        ResourceFactory.create_batch(RESOURCE_NUMBER - 2, created_by=self.reviewer, group=self.group)
