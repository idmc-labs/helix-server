...
class TestCreateContextualUpdate(HelixGraphQLTestCase):
    ...
    def test_valid_creation(self) -> None:
        ...
        self.assertEqual(content["data"]["createContextualUpdate"]["result"]["articleTitle"], self.input["articleTitle"])
        self.assertEqual(len(content["data"]["createContextualUpdate"]["result"]["countries"]), len(self.input["countries"]))
