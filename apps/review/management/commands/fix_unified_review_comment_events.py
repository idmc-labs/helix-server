...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ).update(event_id=models.Subquery(Figure.objects.filter(pk=models.OuterRef("figure_id")).values("event_id")))
        self.stdout.write(self.style.SUCCESS(f"Updated UnifiedReviewComment: {unified_review_comment_qs}"))
