...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        hazard_type_map = {item["id"]: item["type__id"] for item in DisasterSubType.objects.values("type__id", "id")}
        hazard_sub_category_map = {
            item["id"]: item["type__disaster_sub_category"]
            for item in DisasterSubType.objects.values("type__disaster_sub_category", "id")
        }
        hazard_category_map = {
            item["id"]: item["type__disaster_sub_category__category"]
            for item in DisasterSubType.objects.values("type__disaster_sub_category__category", "id")
        }
        ...
        def get_hazard_types(hazard_sub_type):
            ...
            return {
                ...
                "hazard_type_id": hazard_type_map.get(hazard_sub_type_id),
                "hazard_category_id": hazard_category_map.get(hazard_sub_type_id),
                "hazard_sub_category_id": hazard_sub_category_map.get(hazard_sub_type_id),
            }
                ...
                [
                    DisasterLegacy(
                        ...
                        event_name=get_event_name(
                            ...
                            get_hazard_sub_type_name(old_disaster["hazard_sub_type"]),
                        ),
                        ...
                        **get_hazard_types(old_disaster["hazard_sub_type"]),
                    )
