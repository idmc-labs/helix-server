...
class ConflictSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        # Served from GiddDisplacement (aggregated to country x year); model is used only for
        # DRF/spectacular field/schema generation.
...
class DisasterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        # Served from GiddEventDisplacement (cause=DISASTER); model used only for schema generation.
